     ...
     <input type="hidden" id="id" name="id" value="{{$admins->id}}">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <textarea class="form-control" style="height:150px" name="kegiatan" value="" placeholder="Kegiatan">{{ $admins->kegiatan }}</textarea>
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <textarea class="form-control" style="height:150px" name="kendala" placeholder="kendala hari ini">{{ $admins->kendala }}</textarea>
            </div>
        </div>
